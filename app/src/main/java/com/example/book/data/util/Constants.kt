...
import com.example.book.data.model.Credit
import com.example.book.data.model.FontWithName
import com.example.book.data.model.HelpTip
import com.example.book.data.model.NavigationItem
import com.example.book.presentation.main.Screen
import com.example.book.ui.theme.Theme
import com.example.book.presentation.screen.help.components.content.HelpFindBooksContent
import com.example.book.presentation.screen.help.components.HelpAnnotation
...
object Constants {
    ...
    val CREDITS = listOf(
        Credit(
            ...
            website = "https://github.com/Middleboyno2"
        ),
        Credit(
            name = "Đặng ViệtHoàng",
            source = "GitHub",
            ...
            website = "https://github.com/DHoangQ"
        ),
        Credit(
    ...
    val ABOUT_BADGES = listOf(
        ...
        Badge(
            ...
            url = "https://github.com/Middleboyno2/reading_book_app"
        ),
        Badge(
            id = "github_profile",
            drawable = null,
            ...
            url = "https://github.com/Middleboyno2/"
        ),
    )
